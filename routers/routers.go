...
func SetupRouter() *mux.Router {
	...
	router.HandleFunc("/users/delete/{id}", rest.DeleteUser).Methods("DELETE")
	router.HandleFunc("/users/update/{id}", rest.UpdateUser).Methods("PUT")
	...
	*/
	...
	router.HandleFunc("/favorites/delete/{id}", rest.DeleteFavorite).Methods("DELETE")
	router.HandleFunc("/favorites/update/{id}", rest.UpdateFavorite).Methods("PUT")
	*/
	return router
}
